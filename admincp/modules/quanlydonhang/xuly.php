<?php
    ...
    if(isset($_GET['code'])){
        ...
        tbl_cart_details.code_cart='$code_cart' ORDER BY tbl_cart_details.id_cart_details DESC ";
        ...
        if(mysqli_num_rows($query_thongke)==0){
            ...
            $doanhthu = $doanhthu; 
            $donhang = 1;
            $sql_update_thongke = mysqli_query($mysqli,"INSERT INTO tbl_thongke (ngaydat,donhang,doanhthu,soluongban)
            ...
            while($row_tk =mysqli_fetch_array($query_thongke)){
                ...
                // $doanhthu= $row_tk['doanhthu']+$doanhthu;  
                $sql_update_thongke = mysqli_query($mysqli,"UPDATE tbl_thongke SET donhang='$donhang',doanhthu='$doanhthu',
                soluongban='$soluongban', WHERE ngaydat='$now'");
